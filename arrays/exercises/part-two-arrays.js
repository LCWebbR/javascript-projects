...
console.log(`${cargoHold} the list is ${+ cargoHold.length} items long`)

//or

console.log(`${cargoHold[0]}, ${cargoHold[1]}, ${cargoHold[2]}, ${cargoHold[3]}, ${cargoHold[4]}, ${cargoHold[5]} and ${cargoHold[6]}. the list is ${cargoHold.length} items long`) 